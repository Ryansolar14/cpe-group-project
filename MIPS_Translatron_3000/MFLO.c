...
void mflo_reg_assm(void) {
	...
	*/
	...
	// Set the funct 
	setBits_str(5, "010010"); //funct is 18 not 16
...
void mflo_reg_bin(void) {
	...
	if (checkBits(31, "000000") != 0 || checkBits(5, "010010") != 0 /*funct is 18 not 16*/|| checkBits(25, "0000000000") != 0 || checkBits(10, "00000") != 0) {
		state = WRONG_COMMAND;
		return;
	}
